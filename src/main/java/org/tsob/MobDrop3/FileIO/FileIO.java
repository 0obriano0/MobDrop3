...
public class FileIO implements IFileIO{
  ...
  public String getPath() {
    ...
    if(URL.equals(null))
      full_url = "./" + MobDrop3.plugin.getDataFolder().toString() + "/" + FileName;
    else
      full_url = "./" + MobDrop3.plugin.getDataFolder().toString() + "/" + URL + "/" + FileName;
  ...
  public String getString(String path) {
    try {
      ...
      MobDrop3.plugin.saveResource(full_url, true);
  ...
  protected void readFile(){
    ...
    if(URL == null || URL.isEmpty())
      File_load = new File(MobDrop3.plugin.getDataFolder(), FileName);
    else {
      File_load = new File("./" + MobDrop3.plugin.getDataFolder().toString() + "/" + URL + "/" + FileName);
      full_url = URL + "\\" + FileName;
    }
    
    if (!File_load.exists()) MobDrop3.plugin.saveResource(full_url, true);
