...
import org.tsob.MobDrop3.Listener.ChatListener;
import org.tsob.MobDrop3.Listener.DeathListener;
import org.tsob.MobDrop3.Listener.ItemDropListener;
import org.tsob.MobDrop3.Listener.ItemPickupListener;

public class MobDrop3 extends JavaPlugin{
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
      return Command(sender,command,label,args,MobDrop3.class.getClassLoader(),"com.twsbrian." + DataBase.pluginName + ".Command");
    }
  ...
  @Override
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
      return onTabComplete(sender,cmd,label,args,MobDrop3.class.getClassLoader(),"com.twsbrian." + DataBase.pluginName + ".Command");
    }
