...
import org.tsob.MobDrop.Listener.ChatListener;
import org.tsob.MobDrop.Listener.DeathListener;
import org.tsob.MobDrop.Listener.ItemDropListener;
import org.tsob.MobDrop.Listener.ItemPickupListener;
...
public class MobDrop extends JavaPlugin{
  ...
  @Override
    ...
    DataBase.mclang.setLang(MobDrop.plugin.getConfig().getString("lang"));
    DataBase.mclang.reload();
  }
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
      return Command(sender,command,label,args,MobDrop.class.getClassLoader(),"org.tsob." + DataBase.pluginName + ".Command");
    }
  ...
  @Override
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
      return onTabComplete(sender,cmd,label,args,MobDrop.class.getClassLoader(),"org.tsob." + DataBase.pluginName + ".Command");
    }
